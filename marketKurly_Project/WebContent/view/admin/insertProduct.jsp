...
<form action="add" id="frm" class="form-horizontal" method="post" 
...
<div>
 <table class="table" style="border-top: 2px solid #333;">
   <tr>
   	...
   	<td>
   	    <select id="p_category" name="p_category">
   	        ...
   	        <option value="3">생선</option>
   	        <option value="4">애견</option>
   	    </select>
   	</td>
  </tr>
   ...
   <tr>
   	...
   	<td>
   	    <input type="text" size="98" maxlength="100" name="p_name" id="p_name" placeholder="상품명을 입력해주세요.">
   	</td>
   </tr>
  ...
  <tr>
   	...
   	<td>
	   	<input type="text" size="98" maxlength="100" name="p_price" id="p_price" placeholder="가격을 입력해주세요.">
   	</td>
  </tr>
  
  	<tr>
  		<td width="70" align="center"> 상품수량 </td>
  		<td>
  			<input type="text" size="98" maxlength="100" name="p_count" id="p_count" placeholder="상품재고를 입력하세요">
  		</td>
  	</tr>
  
   <tr>
   	<td width="70" align="center"> 상세 내용 </td>
   	<td width="300" align="left"><textarea name="p_content" id="p_content" rows="13" cols="100"  placeholder="상세 내용을 입력해주세요."></textarea></td>
  </tr>
  <tr>
      <td width="70" align="center">상품 이미지</td>
      <td><input type="file" name="uploadFile" class="form-control" id="p_img"></td>
    </tr>
   <tr>
