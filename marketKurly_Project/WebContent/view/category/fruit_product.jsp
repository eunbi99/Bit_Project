      ...
      <div class="container">
         <div class="row text-center">
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_ap.jsp?p_id=7"><img src="../assets/images/st3.png" alt="Work"></a>
                  </div>
                  <div class="desc">
                     <h3 ><a style="font-family : sans-serif;" href="detail_ban.jsp">[제철과일]딸기</a></h3>
                     <span style="font-family : sans-serif;">20%할인<br>3,150원</span>
            ...
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_ban.jsp?p_id=4"><img src="../assets/images/pban1.png" alt="Work" href="../detail/detail_ban.jsp"></a>
                  </div>
                  <div class="desc">
                     <h3><a style="font-family : sans-serif;" href="detail_ban.jsp">[제철 과일]바나나</a></h3>
                     <span style="font-family : sans-serif;">15% 3,150원</span>
                  </div>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_kiwi.jsp?p_id=8"><img src="../assets/images/kiwi.png" alt="Work"></a>
                  </div>
                  <div class="desc">
                     <h3><a style="font-family : sans-serif;" href="detail.ki.html">[제철과일]키위</a></h3>
                     <span style="font-family : sans-serif;">7% 9,900원</span>
                  </div>
               </div>
            </div>
