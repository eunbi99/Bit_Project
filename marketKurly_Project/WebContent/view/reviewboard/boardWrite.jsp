			...
			<form action='add' method='post'>
				...
				<table class="table" style="border-top: 2px solid #333;">
					<tr>
						...
						<td><input type="text" id="userid" name="writer" readonly="readonly" value="${sessionScope.loginUser.userId}"></td>
						
					<tr>
						<td width="70" align="center">제목</td>
						<td><input type="text" name='boardTitle' size="98"
							maxlength="100" placeholder="제목을 입력해주세요."></td>
					</tr>

					<tr>
						<td width="70" align="center">내용</td>
						<td width="300" align="left"><textarea name="boardContent"
								rows="13" cols="100" placeholder="내용을 입력해주세요."></textarea></td>
					</tr>

					<tr>
						<td align="right" colspan="2"><input type="submit"
							class="btn_update" value="글작성" style="background-color: #378bb3;">

							<input type="button" class="btn_list" value="목록"
							style="background-color: #378bb3;"
							onclick="document.location.href='list'"></td>
						<!--
