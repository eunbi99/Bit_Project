	...
	<section style="margin: 0 100px 0 100px;">
		<div class="boardList">
			<div class="board_title">
				<h3 class="title"
					style="font-family: sans-serif; font-weight: bold; text-align: center";>
					글 내용</h3>
			</div>
		</div>
		<!--글 상세보기 -->
			...
			<form action='detail' method='get'>
				<table class="table" style="border-top: 2px solid #333;">
					...
					<tr>
						...
						<td>${boards.registrationDate}</td>
					</tr>
					<tr>
						<td width="70" align="center">내용</td>
						<td width="300" align="left">${boards.boardContent}</td>
					</tr>
					...
					<tr>
						<td align="right" colspan="2">
							...
							<input type="button" class="btn_delete" value="글삭제" 
							style="background-color: #378bb3;" onclick="location.href='delete?no=${boards.boardNo}'">
														
							<input type="button" class="btn_list" value="목록"
							style="background-color: #378bb3;" onclick="location.href='list'">
						</td>
					</tr>
				</table>
			</form>
