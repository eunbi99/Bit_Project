			...
			<form action='update' method='post'>
				...
				<table class="table" style="border-top: 2px solid #333;">
					...
					<tr>
						...
						<td><input type="text" name="writer" size="40" maxlength="50"
							value="${reviewboard.writer}"></td>
					<tr>
						<td width="70" align="center">제목</td>
						<td><input type="text" name="boardTitle" size="98"
							maxlength="100" value="${reviewboard.boardTitle}"></td>
					</tr>

					<tr>
						<td width="70" align="center">내용</td>
						<td width="300" align="left"><textarea name="boardContent"
								rows="13" cols="100" value="${reviewboard.boardContent}"></textarea></td>
					</tr>

					<tr>
						<td align="right" colspan="2">
						
						<input type="button" class="btn_update" value="수정하기"
						style="background-color: #378bb3;" onclick="location.href='update'"> 
						
						<!-- <input type="reset" class="btn_reset" value="다시작성" style="background-color: #378bb3;"> -->
						
						<input type="button" class="btn_list" value="목록"
						style="background-color: #378bb3;" onclick="location.href='list'"></td>
						
						<!--
   		<td align="right" colspan="2"> 
   			<input class="btn btn-outline-info" type="button" id="submit" value="수정하기">
